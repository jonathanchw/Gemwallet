...
public enum Localized {
    ...
    public enum Asset {
        ...
        public static func buyAsset(_ p1: Any) -> String {
            Localized.tr("Localizable", "asset.buy_asset", String(describing: p1), fallback: "Buy %@")
        }
        ...
        public static func viewAddressOn(_ p1: Any) -> String {
            Localized.tr("Localizable", "asset.view_address_on", String(describing: p1), fallback: "View address on %@")
        }

        /// View token on %@
        public static func viewTokenOn(_ p1: Any) -> String {
            Localized.tr("Localizable", "asset.view_token_on", String(describing: p1), fallback: "View token on %@")
        }
        ...
        public enum State {
            public enum Empty {
                ...
                public static func description(_ p1: Any) -> String {
                    Localized.tr("Localizable", "asset.state.empty.description", String(describing: p1), fallback: "Receive, swap or buy %@")
                }
    ...
    public enum Banner {
        public enum AccountActivation {
            ...
            public static func description(_ p1: Any, _ p2: Any) -> String {
                Localized.tr("Localizable", "banner.account_activation.description", String(describing: p1), String(describing: p2), fallback: "The %@ network requires a one time fee of %@.")
            }
        ...
        public enum ActivateAsset {
            ...
            public static func description(_ p1: Any, _ p2: Any) -> String {
                Localized.tr("Localizable", "banner.activate_asset.description", String(describing: p1), String(describing: p2), fallback: "To use the %@ asset, you must first enable it on the %@ network by fulfilling the network’s specific requirements.")
            }
        }
        ...
        public enum Stake {
            ...
            public static func description(_ p1: Any) -> String {
                Localized.tr("Localizable", "banner.stake.description", String(describing: p1), fallback: "Earn %@ rewards on your stake while you sleep.")
            }

            /// Start staking %@
            public static func title(_ p1: Any) -> String {
                Localized.tr("Localizable", "banner.stake.title", String(describing: p1), fallback: "Start staking %@")
            }
        }
    }
    ...
    public enum Buy {
        ...
        /// Buy %@
        public static func title(_ p1: Any) -> String {
            Localized.tr("Localizable", "buy.title", String(describing: p1), fallback: "Buy %@")
        }
    ...
    public enum Common {
        ...
        public static func copied(_ p1: Any) -> String {
            Localized.tr("Localizable", "common.copied", String(describing: p1), fallback: "Copied: %@")
        }
        ...
        public static func deleteConfirmation(_ p1: Any) -> String {
            Localized.tr("Localizable", "common.delete_confirmation", String(describing: p1), fallback: "Are sure you want to delete %@?")
        }
        ...
        public static func latencyInMs(_ p1: Int) -> String {
            Localized.tr("Localizable", "common.latency_in_ms", p1, fallback: "%d ms")
        }
        ...
        public static func show(_ p1: Any) -> String {
            Localized.tr("Localizable", "common.show", String(describing: p1), fallback: "Show %@")
        }
    ...
    public enum Earn {
        public enum State {
            public enum Empty {
                /// Deposit your first %@
                public static func description(_ p1: Any) -> String {
                    Localized.tr("Localizable", "earn.state.empty.description", String(describing: p1), fallback: "Deposit your first %@")
                }
    ...
    public enum Errors {
        ...
        public static func createWallet(_ p1: Any) -> String {
            Localized.tr("Localizable", "errors.create_wallet", String(describing: p1), fallback: "Create Wallet Error: %@")
        }
        ...
        public static func dustThreshold(_ p1: Any) -> String {
            Localized.tr("Localizable", "errors.dust_threshold", String(describing: p1), fallback: "The transaction failed because the amount is too small to meet the %@ network’s minimum requirement (dust threshold). This limit ensures the transaction value covers the fees and processing costs.")
        }
        ...
        public static func invalidAssetAddress(_ p1: Any) -> String {
            Localized.tr("Localizable", "errors.invalid_asset_address", String(describing: p1), fallback: "Invalid %@ address")
        }
        ...
        public static func required(_ p1: Any) -> String {
            Localized.tr("Localizable", "errors.required", String(describing: p1), fallback: "%@ is required")
        }

        /// Transfer Error: %@
        public static func transfer(_ p1: Any) -> String {
            Localized.tr("Localizable", "errors.transfer", String(describing: p1), fallback: "Transfer Error: %@")
        }
        ...
        public static func validation(_ p1: Any) -> String {
            Localized.tr("Localizable", "errors.validation", String(describing: p1), fallback: "Validation Error: %@")
        }
        ...
        public enum Import {
            ...
            public static func invalidSecretPhraseWord(_ p1: Any) -> String {
                Localized.tr("Localizable", "errors.import.invalid_secret_phrase_word", String(describing: p1), fallback: "Invalid Secret Phrase word: %@")
            }
        }
        ...
        public enum ScanTransaction {
            ...
            public static func memoRequired(_ p1: Any) -> String {
                Localized.tr("Localizable", "errors.scan_transaction.memo_required", String(describing: p1), fallback: "%@ destination wallet address requires a destination tag / memo")
            }
        ...
        public enum Swap {
            ...
            public static func minimumAmount(_ p1: Any) -> String {
                Localized.tr("Localizable", "errors.swap.minimum_amount", String(describing: p1), fallback: "Minimum trade amount is %@. Please enter a higher amount.")
            }
        ...
        public enum Wallets {
            public enum Limit {
                ...
                public static func description(_ p1: Int) -> String {
                    Localized.tr("Localizable", "errors.wallets.limit.description", p1, fallback: "You’ve reached the maximum number of wallets allowed (%d). Please remove an existing wallet to add or create a new one.")
                }
    ...
    public enum FeeRate {
        ...
        public static func gwei(_ p1: Any) -> String {
            Localized.tr("Localizable", "fee_rate.gwei", String(describing: p1), fallback: "%@ gwei")
        }

        /// %@ sat/B
        public static func satB(_ p1: Any) -> String {
            Localized.tr("Localizable", "fee_rate.satB", String(describing: p1), fallback: "%@ sat/B")
        }

        /// %@ sat/vB
        public static func satvB(_ p1: Any) -> String {
            Localized.tr("Localizable", "fee_rate.satvB", String(describing: p1), fallback: "%@ sat/vB")
        }
    }
    ...
    public enum Info {
        ...
        public enum InsufficientBalance {
            ...
            public static func description(_ p1: Any) -> String {
                Localized.tr("Localizable", "info.insufficient_balance.description", String(describing: p1), fallback: "You don’t have enough %@ to complete this transaction. Please top up, receive, or swap in your wallet and try again.")
            }
        ...
        public enum InsufficientNetworkFeeBalance {
            ...
            public static func description(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
                Localized.tr("Localizable", "info.insufficient_network_fee_balance.description", String(describing: p1), String(describing: p2), String(describing: p3), fallback: "This transaction requires %@ to cover the network fee paid to %@ miners, not Gem Wallet. Ensure you have enough %@.")
            }

            /// %@ required
            public static func title(_ p1: Any) -> String {
                Localized.tr("Localizable", "info.insufficient_network_fee_balance.title", String(describing: p1), fallback: "%@ required")
            }
        }
        ...
        public enum NetworkFee {
            ...
            public static func description(_ p1: Any, _ p2: Any) -> String {
                Localized.tr("Localizable", "info.network_fee.description", String(describing: p1), String(describing: p2), fallback: "Every transaction on the %@ network requires a fee in %@ paid to miners to process your transaction, not Gem Wallet. Network fees varies based on network usage.")
            }
        ...
        public enum StakeMinimumAmount {
            ...
            public static func description(_ p1: Any, _ p2: Any) -> String {
                Localized.tr("Localizable", "info.stake_minimum_amount.description", String(describing: p1), String(describing: p2), fallback: "On the %@ network, the minimum staking requirement is %@.")
            }
    ...
    public enum Input {
        ...
        public static func enterAmountTo(_ p1: Any) -> String {
            Localized.tr("Localizable", "input.enter_amount_to", String(describing: p1), fallback: "Please enter amount to %@")
        }
    }
    ...
    public enum Perpetual {
        ...
        public static func closeDirection(_ p1: Any) -> String {
            Localized.tr("Localizable", "perpetual.close_direction", String(describing: p1), fallback: "Close %@")
        }
        ...
        public static func increaseDirection(_ p1: Any) -> String {
            Localized.tr("Localizable", "perpetual.increase_direction", String(describing: p1), fallback: "Increase %@")
        }
        ...
        public static func openDirection(_ p1: Any) -> String {
            Localized.tr("Localizable", "perpetual.open_direction", String(describing: p1), fallback: "Open %@")
        }
        ...
        public static func reduceDirection(_ p1: Any) -> String {
            Localized.tr("Localizable", "perpetual.reduce_direction", String(describing: p1), fallback: "Reduce %@")
        }
    ...
    public enum PriceAlerts {
        ...
        public static func addedFor(_ p1: Any) -> String {
            Localized.tr("Localizable", "price_alerts.added_for", String(describing: p1), fallback: "Set price alert %@")
        }
        ...
        public static func disabledFor(_ p1: Any) -> String {
            Localized.tr("Localizable", "price_alerts.disabled_for", String(describing: p1), fallback: "Price alert disabled for %@")
        }

        /// Price alert enabled for %@
        public static func enabledFor(_ p1: Any) -> String {
            Localized.tr("Localizable", "price_alerts.enabled_for", String(describing: p1), fallback: "Price alert enabled for %@")
        }
    ...
    public enum Receive {
        /// Receive %@
        public static func title(_ p1: Any) -> String {
            Localized.tr("Localizable", "receive.title", String(describing: p1), fallback: "Receive %@")
        }

        /// This is your address — send only %@ on the %@ network.
        public static func warning(_ p1: Any, _ p2: Any) -> String {
            Localized.tr("Localizable", "receive.warning", String(describing: p1), String(describing: p2), fallback: "This is your address — send only %@ on the %@ network.")
        }
    }
    ...
    public enum Rewards {
        ...
        public static func confirmRedeem(_ p1: Any, _ p2: Any) -> String {
            Localized.tr("Localizable", "rewards.confirm_redeem", String(describing: p1), String(describing: p2), fallback: "Get %@ for %@!")
        }
        ...
        public static func shareText(_ p1: Any) -> String {
            Localized.tr("Localizable", "rewards.share_text", String(describing: p1), fallback: "Join Gem Wallet with my referral link and earn rewards: %@")
        }
        ...
        public enum InviteFriends {
            ...
            public static func description(_ p1: Any) -> String {
                Localized.tr("Localizable", "rewards.invite_friends.description", String(describing: p1), fallback: "Earn %@ points for each friend who joins.")
            }
        ...
        public enum Pending {
            /// Available in %@
            public static func description(_ p1: Any) -> String {
                Localized.tr("Localizable", "rewards.pending.description", String(describing: p1), fallback: "Available in %@")
            }
        ...
        public enum WaysSpend {
            ...
            public enum Asset {
                /// Get %@
                public static func title(_ p1: Any) -> String {
                    Localized.tr("Localizable", "rewards.ways_spend.asset.title", String(describing: p1), fallback: "Get %@")
                }
            }
        }
    }
    ...
    public enum Sell {
        /// Sell %@
        public static func title(_ p1: Any) -> String {
            Localized.tr("Localizable", "sell.title", String(describing: p1), fallback: "Sell %@")
        }
    }
    ...
    public enum Settings {
        ...
        public static func disableValue(_ p1: Any) -> String {
            Localized.tr("Localizable", "settings.disable_value", String(describing: p1), fallback: "Disable %@")
        }
        ...
        public static func enableValue(_ p1: Any) -> String {
            Localized.tr("Localizable", "settings.enable_value", String(describing: p1), fallback: "Enable %@")
        }
    ...
    public enum Simulation {
        public enum Header {
            ...
            public static func unlimitedAsset(_ p1: Any) -> String {
                Localized.tr("Localizable", "simulation.header.unlimited_asset", String(describing: p1), fallback: "Unlimited %@")
            }
        }
    ...
    public enum Stake {
        ...
        public static func apr(_ p1: Any) -> String {
            Localized.tr("Localizable", "stake.apr", String(describing: p1), fallback: "APR %@")
        }
        ...
        public enum State {
            public enum Empty {
                /// Stake your first %@
                public static func description(_ p1: Any) -> String {
                    Localized.tr("Localizable", "stake.state.empty.description", String(describing: p1), fallback: "Stake your first %@")
                }
    ...
    public enum Swap {
        ...
        public enum PriceImpactWarning {
            ...
            public static func description(_ p1: Any, _ p2: Any) -> String {
                Localized.tr("Localizable", "swap.price_impact_warning.description", String(describing: p1), String(describing: p2), fallback: "You will lose %@ of your %@ in this trade. Are you sure you want to proceed?")
            }
    ...
    public enum Transaction {
        ...
        public static func viewOn(_ p1: Any) -> String {
            Localized.tr("Localizable", "transaction.view_on", String(describing: p1), fallback: "View on %@")
        }
    ...
    public enum Transfer {
        ...
        public static func balance(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.balance", String(describing: p1), fallback: "Balance: %@")
        }
        ...
        public static func insufficientBalance(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.insufficient_balance", String(describing: p1), fallback: "Insufficient %@ balance.")
        }

        /// Insufficient %@ balance to cover network fees.
        public static func insufficientNetworkFeeBalance(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.insufficient_network_fee_balance", String(describing: p1), fallback: "Insufficient %@ balance to cover network fees.")
        }
        ...
        public static func maximumAmount(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.maximum_amount", String(describing: p1), fallback: "Maximum Amount is %@")
        }
        ...
        public static func minimumAccountBalance(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.minimum_account_balance", String(describing: p1), fallback: "A minimum %@ balance must remain after this, unless you’re using your full balance.")
        }

        /// Minimum Amount is %@
        public static func minimumAmount(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.minimum_amount", String(describing: p1), fallback: "Minimum Amount is %@")
        }
        ...
        public static func reservedFees(_ p1: Any) -> String {
            Localized.tr("Localizable", "transfer.reserved_fees", String(describing: p1), fallback: "We’ve left %@ in your balance to cover future network fees.")
        }
    ...
    public enum UpdateApp {
        ...
        public static func description(_ p1: Any) -> String {
            Localized.tr("Localizable", "update_app.description", String(describing: p1), fallback: "Version %@ of the app is now available. Update and enjoy the latest features and improvements.")
        }
    ...
    public enum Wallet {
        ...
        public static func availableBalance(_ p1: Any) -> String {
            Localized.tr("Localizable", "wallet.available_balance", String(describing: p1), fallback: "Available: %@")
        }
        ...
        public static func defaultName(_ p1: Int) -> String {
            Localized.tr("Localizable", "wallet.default_name", p1, fallback: "Wallet #%d")
        }

        /// %@ Wallet #%d
        public static func defaultNameChain(_ p1: Any, _ p2: Int) -> String {
            Localized.tr("Localizable", "wallet.default_name_chain", String(describing: p1), p2, fallback: "%@ Wallet #%d")
        }
        ...
        public enum Import {
            ...
            public static func alreadyImportedMessage(_ p1: UnsafePointer<CChar>) -> String {
                Localized.tr("Localizable", "wallet.import.already_imported_message", p1, fallback: "Already added as \"%s\"")
            }
            ...
            public static func switchToWallet(_ p1: UnsafePointer<CChar>) -> String {
                Localized.tr("Localizable", "wallet.import.switch_to_wallet", p1, fallback: "Switch to %s")
            }
    ...
    public enum Warnings {
        ...
        public static func multiSignatureBlocked(_ p1: Any) -> String {
            Localized.tr("Localizable", "warnings.multi_signature_blocked", String(describing: p1), fallback: "Do not transfer funds to this %@ Multi-Signature wallet unless you are certain you control the private keys. Failure to do so could expose you to scams, and you may permanently lose your assets.")
        }
    }
