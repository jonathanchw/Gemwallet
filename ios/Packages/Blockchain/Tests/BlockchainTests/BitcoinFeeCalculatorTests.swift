...
struct BitcoinServiceTests {
    ...
    var feeInput: FeeInput {
        FeeInput(
            ...
            value: BigInt(105_910),
            balance: BigInt(105_910),
    ...
    @Test
    func calculateFeeSuccess() throws {
    ...
    @Test
    func calculateFeeIncorrectAmount() throws {
    ...
    @Test
    func calculateFeeCantEstimateFee() throws {
