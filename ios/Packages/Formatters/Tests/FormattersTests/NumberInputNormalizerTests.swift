...
struct NumberInputNormalizerTests {
    ...
    @Test
    func inputsWithoutGroupingSeparator() {
    ...
    @Test
    func inputWithoutDecimalSeparator() {
        let testCases: [(locale: Locale, input: String, expected: String)] = [
